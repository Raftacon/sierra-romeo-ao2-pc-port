...
// Army of Two polls from both its movie thread and its game thread. These
// public operations rebuild shared device/owner vectors and slot assignment.
// Serialize the complete transaction, including use of the rebuilt vectors.
// Upstream source: ReXGlue f5337cdc947ff6d4c4196737e2c807a48f2a1fc2.
std::mutex input_poll_mutex;
...
X_RESULT InputSystem::GetCapabilities(uint32_t user_index, uint32_t flags,
  ...
  std::lock_guard lock(input_poll_mutex);
